...
# --- ViYaRN (Swin-RoPE) ---
_C.MODEL.SWIN_ROPE.VIYARN_ENABLE = True
_C.MODEL.SWIN_ROPE.BASE_WINDOW_SIZE = 7

_C.MODEL.SWIN_ROPE.YARN_GAMMA_LO = 2.3
_C.MODEL.SWIN_ROPE.YARN_GAMMA_HI = 1.7
_C.MODEL.SWIN_ROPE.YARN_TRANSITION = "cos"   # "cos" or "linear"
_C.MODEL.SWIN_ROPE.ANISOTROPIC = True        # square input 下无差别，但保留

_C.MODEL.SWIN_ROPE.VIYARN_DEPTH_RAMP_P = 1.0
_C.MODEL.SWIN_ROPE.VIYARN_SCALE_THRESHOLD = 1.05

_C.MODEL.SWIN_ROPE.VIYARN_ALPHA_MAX = 1.0
